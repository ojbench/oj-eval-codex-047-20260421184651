...
def main():
    ...
    submit_src_parser = subparsers.add_parser("submit-src", help="Submit single source file as code")
    submit_src_parser.add_argument("--problem-id", type=int, required=True, help="Problem ID")
    submit_src_parser.add_argument("--file", type=str, default="src.hpp", help="Source file path (default: src.hpp)")
    submit_src_parser.add_argument("--language", type=str, default="cpp", help="Language (default: cpp)")
